...
const Nav = () => {
  ...
  return (
    ...
    <nav className="nav text-gray-400  body-font md:flex-row md:ml-auto">
        ...
        <Image id="logo" className="flex title-font font-medium items-center text-blue-300 mb-4 md:mb-0" src="/logo.png" alt="Logo" width={100} height={50} priority style={{ height: 'auto' }} />
        <Image id="title" src="/waideek.png" alt="Waideek" width={200} height={100} style={{ height: 'auto' }} />
