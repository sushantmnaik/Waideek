...
export default function About({ markdownContent }: AboutProps) { 
  ...
  return (
    <>
    <body className="bg-gray-900 text-blue-200">
      ...
      {dataset.map((app, index) => {
        ...
        return (
          <div className="followbox bg-gray-900  bg-opacity-50 rounded m-2 shadow-2xl lg:w-1/4 md:w-1/2 p-1 w-full" key={index}>
